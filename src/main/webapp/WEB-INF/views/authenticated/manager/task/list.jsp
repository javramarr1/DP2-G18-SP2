...
<acme:list >
	...
	<acme:list-column code="manager.task.list.label.description" path="description" width="40%"/>
	<acme:list-column code="manager.task.list.label.op_link" path="op_link" width="20%"/>		
</acme:list>
