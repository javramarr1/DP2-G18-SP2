...
<%@page language="java" import="acme.framework.helpers.PrincipalHelper,acme.entities.roles.Provider,acme.entities.roles.Consumer,acme.entities.shouts.Shout"%>
...
<acme:menu-bar code="master.menu.home">
	...
	<acme:menu-right>
		...
		<acme:menu-option code="master.menu.user-account" access="isAuthenticated()&&!hasRole('Manager')">
			...
			<acme:menu-suboption code="master.menu.user-account.become-manager" action="/authenticated/manager/create"/>
		</acme:menu-option>
